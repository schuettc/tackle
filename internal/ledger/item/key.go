// Package item is the ledger's pure data model: item keys, decisions, until
...
// case-insensitive and the ledger keeps one spelling); Branch and Path keep
// their case.
type Key struct {
	Kind    Kind
...
// File is the item's decision file, relative to the ledger repo root and
// slash-separated.
