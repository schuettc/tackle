// Package view renders the ledger's Markdown boards (README.md,
// CONTRIBUTIONS.md, MACHINES.md), committed to the private ledger repo and
// read on github.com.
package view
...
func readme(r engine.Result) []byte {
	...
	b.WriteString("# ledger\n\nWritten by `ledger sync`; decide with `ledger decide <key> <disposition>`.\n\n")
