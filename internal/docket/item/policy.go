...
// Policy holds the attention thresholds, in days (policy.toml in the docket
...
// DefaultPolicy is what `docket init` writes.
...
func EncodePolicy(p Policy) ([]byte, error) {
	...
	buf.WriteString("# Attention thresholds for docket, in days. Every machine reads this file.\n")
